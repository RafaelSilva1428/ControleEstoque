...
public class VisualCadastroFornecedor extends javax.swing.JDialog {
    ControleFornecedor controleFornecedor = new ControleFornecedor();
    Fornecedor fornecedor = new Fornecedor();
    Endereco end = new Endereco();

    VisualCadastroFornecedor() {
        setModal(true);
        initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jTFComplemento, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(56, 56, 56))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
            ...
            if(validarCamposNumericos()){
                ...
                if(verificarEmail){
                    ...
                    if(resultadoValidarCNPJ){
                        fornecedor = formarObjetoFornecedor();
                        boolean resultadoCadastroFornecedor = controleFornecedor.cadastrarFornecedor(fornecedor);
                        if(resultadoCadastroFornecedor){
                            JOptionPane.showMessageDialog(null, "Fornecedor "+jTFRazaoSocial.getText()+" cadastro");
                            limparCamposTexto();
                        }else{
    ...
    public Fornecedor formarObjetoFornecedor(){
        ...
        fornecedor.setNome(jTFRazaoSocial.getText().toUpperCase());
