...
public class VisualAtualizaCadastroCliente extends javax.swing.JDialog {
    ControleCliente controleCliente = new ControleCliente();
    Cliente cliente = new Cliente();
    Endereco end = new Endereco();

    VisualAtualizaCadastroCliente() {
        setModal(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Atualizar cadastro de Cliente");
            ...
            if(validarCamposNumericos()){
                ...
                if(verificarEmail){
                    ...
                    if(resultadoValidarNumeroRegistro.equals("")){
                        cliente = formarObjetoCliente();
                        boolean resultadoCadastro =  controleCliente.atualizarCliente(cliente);
                        if(resultadoCadastro){
                            JOptionPane.showMessageDialog(null, "Cliente "+jTFNome.getText()+" atualizado com sucesso");
                            limparCamposTexto();
                        }else{
    ...
    public void preencherCampos(Cliente clien){
        cliente.setId(clien.getId());
        end.setId(clien.getEndereco().getId());
        jTFRua.setText(clien.getEndereco().getRua());
        jTFCep.setText(clien.getEndereco().getCep());
        jTFBairro.setText(clien.getEndereco().getBairro());
        jTFCidade.setText(clien.getEndereco().getCidade());
        jTFEstado.setText(clien.getEndereco().getEstado());
        jTFNResidencial.setText(clien.getEndereco().getNumero());
        jTFComplemento.setText(clien.getEndereco().getComplemento());
        
        jTFNome.setText(clien.getNome());
        jTFNumeroRegistro.setText(clien.getNumeroRegistro());
        jTFEmail.setText(clien.getEmail());
        jFTFTelefone.setText(clien.getTelefone());
        if(clien.getTipoPessoa().equals("Fisíca")){
            jCBTipoPessoa.setSelectedIndex(1);
        }else{
            jCBTipoPessoa.setSelectedIndex(2);
        }
    }
